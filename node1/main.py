"""
main.py  —  MicroPython firmware for ESP32 "node_1"
...
I2S_SCK_PIN = 26    # Serial Clock  (BCLK)
I2S_WS_PIN  = 25    # Word Select   (LRCLK)
I2S_SD_PIN  = 33    # Serial Data   (DOUT)
...
class SocketIOClient:
    ...
    def emit_audio(self, node_id, audio_b64):
        ...
        """
        # 42["audio_stream",{"node_id":"node_1","audio":"<b64>"}]
